...
public class MovielensRating {
	...
	private static Function<String, Tuple3<Integer, Integer, Integer>> funcMapStringToTuple = new Function<String, Tuple3<Integer, Integer, Integer>>() {
		/**
			 * 
			 */
	...
	public static void task2a() {
		...
		JavaRDD<Tuple3<Integer, Integer, Integer>> rddMovie = movieUdata.filter(funcReduceByRate)
	...
	private static PairFunction<String, Integer, ArrayList<Tuple2<Integer, Integer>>> funcUDataMapStringToPair = new PairFunction<String, Integer, ArrayList<Tuple2<Integer, Integer>>>() {
		/**
		* 
		*/
	...
	private static Function2<ArrayList<Tuple2<Integer, Integer>>, ArrayList<Tuple2<Integer, Integer>>, ArrayList<Tuple2<Integer, Integer>>> funcUDataReduceByUser = new Function2<ArrayList<Tuple2<Integer, Integer>>, ArrayList<Tuple2<Integer, Integer>>, ArrayList<Tuple2<Integer, Integer>>>() {
	...
	private static PairFunction<String, Integer, Tuple2<String, Integer>> funcUItemMapStringToPair = new PairFunction<String, Integer, Tuple2<String, Integer>>() {
		/**
		 * 
		 */
	...
	public static void task2b() {
		...
		JavaPairRDD<Integer, Tuple2<String, Integer>> rddMovieItem = movieUItem.mapToPair(funcUItemMapStringToPair);// sortByKey();
		...
		JavaPairRDD<Integer, ArrayList<Tuple2<Integer, Integer>>> rddUserMoviePair = movieUdata
				.mapToPair(funcUDataMapStringToPair).reduceByKey(funcUDataReduceByUser);
		...
		System.out.println("total user number is: " + rddUserMoviePair.count());
